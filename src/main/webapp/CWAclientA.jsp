          ...
          <div class="container-fluid">
           ...
           <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="active"><a href="CWAclientA.jsp">Home</a></li>
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="CWACreadcoupon.jsp" role="button">Go to details</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="CWCcart.jsp" role="button">Go to shopping cart</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="CWACvalidatecoupon.jsp" role="button">Go to page</a></p>
            </div>
          </div>
        </div>
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>Find Coupons</h1>
              <p><a class="btn btn-lg btn-primary" href="CWCfindbytime.jsp" role="button">Learn more</a></p>
            </div>
          </div>
        </div>

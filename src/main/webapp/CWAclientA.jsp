    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="C:\js\1.jpg" alt="First slide" width="400" height="800">
          <div class="container">
        ...
        <div class="item">
          <img class="second-slide" src="C:\js\2.jpg" alt="Second slide" width="400" height="800">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img class="third-slide" src="C:\js\3.jpg" alt="Third slide" width="400" height="800">
          <div class="container">
            <div class="carousel-caption">
